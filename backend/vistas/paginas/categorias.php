      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-check">
            ...
            <span class="badge badge-secondary"><i class="fas fa-bed"></i> Cama </span>
            </label>
          </div>
          ...
          <div class="form-check">
            ...
            <span class="badge badge-secondary"><i class="fas fa-water"></i> Baño </span>
            </label>
          </div>
    ...
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="form-check">
            <label class="form-check-label">
            <input class="editarCheckbox" type="checkbox" class="ml-3" value="TV ,fas fa-tv"> 
            <span class="badge badge-secondary"><i class="fas fa-tv"></i> TV </span>
            </label>
          </div>
